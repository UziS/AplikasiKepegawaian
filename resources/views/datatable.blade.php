          ...
          <table id="laravel_crud" class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr id="row_{{$data->id}}">
                    ...
                    <td>{{ $data->agama }}</td>
                   <td><a href="javascript:void(0)" data-id="{{ $data->id }}" onclick="editPost(event.target)" class="btn btn-info">Edit</a></td>
                   <td>
                    <a href="javascript:void(0)" data-id="{{ $data->id }}" class="btn btn-danger" onclick="deletePost(event.target)">Delete</a></td>
                </tr>
                @endforeach
            </tbody>
          </table>
